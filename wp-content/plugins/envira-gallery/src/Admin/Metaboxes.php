...
class Metaboxes {
	...
	public function __construct() {
		...
		if (
			...
			( defined( 'DOING_AJAX' ) && DOING_AJAX && ( ! class_exists( 'Woo_Variation_Gallery' ) && ! class_exists( 'ACF' ) && ! isset( $GLOBALS['theiaSmartThumbnails'] ) && empty( $GLOBALS['theiaSmartThumbnails'] ) ) )
		) { /* GH 3489, 3912 */
